              ...
              <tbody>
                <tr>
                  <td style="padding: 30px"> 
                    ...
                    <p>El informe de la carpeta {{ $data['carpeta']->name }} del trabajador {{ $data['carpeta']->trabajador->name }} ya esta disponible en la plataforma de <a href="https://sistema.check360.cl" target="_blank">Check 360</a>
                    <br><br>
