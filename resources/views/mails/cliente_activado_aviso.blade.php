              ...
              <tbody>
                <tr>
                  <td style="padding: 30px"> 
                    ...
                    <p>El cliente {{$data['nombre'] }} ha sido {{$data['cliente']->estado == 1 ? 'activado' : 'desactivado'}}.
                    La {{$data['cliente']->estado == 1 ? 'activación' : 'desactivación'}} fue realizada por {{$data['user']->name}}.
                    <br>
                    <br>
