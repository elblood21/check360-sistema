              ...
              <tbody>
                <tr>
                  <td style="padding: 30px"> 
                    ...
                    <p>
                    Se ha aprobado el cliente {{$data['cliente']->razon_social}}.
                    {{ $data['user']->name }} ha realizado la aprobación.
                    <br>
                    Razon social: {{$data['cliente']->razon_social}}<br>
                    RUT: {{$data['cliente']->rut}}<br>
                    Giro: {{$data['cliente']->giro}}<br>
                    </p>
                    <br>
                    <br>
