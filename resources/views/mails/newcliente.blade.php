              ...
              <tbody>
                <tr>
                  <td style="padding: 30px"> 
                    ...
                    <p>Te has registrado como cliente en <a href="{{$data['plataforma']}}" target="_blank">Check 360</a>.
                      Se ha creado un usuario administrador para que puedas comenzar a utilizar la plataforma.
                      Seras contactado por un ejecutivo para continuar con el uso de la plataforma de Check 360.
