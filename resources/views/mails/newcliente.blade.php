...
<head>
    ...
    <title>{{ $titulo ?? 'Bienvenido a Check 360' }}</title>
</head>
<body style="font-family: 'Segoe UI', Tahoma, Geneva, Verdana, sans-serif; line-height: 1.6; color: #333; max-width: 600px; margin: 0 auto; padding: 20px; background-color: #f4f7f6;">
    ...
    <div style="background-color: #ffffff; padding: 30px; border-radius: 0 0 10px 10px; box-shadow: 0 4px 6px rgba(0,0,0,0.05);">
        <h2 style="color: #1e3a8a; margin-top: 0;">{{ $titulo ?? '¡Bienvenido a Check 360!' }}</h2>
        
        <p>Hola,</p>
        
        <p>Te has registrado exitosamente como cliente en <strong>Check 360</strong>. Estamos muy contentos de que te hayas unido a nuestra plataforma.</p>
        
        <p>Se ha creado una cuenta de administrador para que puedas comenzar a configurar tu perfil. Próximamente serás contactado por uno de nuestros ejecutivos para brindarte una asesoría personalizada sobre el uso de la plataforma.</p>
        ...
        <div style="text-align: center; margin: 30px 0;">
            <a href="{{ $plataforma }}" style="background-color: #1e3a8a; color: white; padding: 12px 30px; text-decoration: none; border-radius: 5px; font-weight: bold; display: inline-block;">Ingresar al Sistema</a>
        </div>
        
        <p>Si tienes alguna duda inmediata, no dudes en contactarnos.</p>
